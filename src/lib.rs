...
impl std::error::Error for Error {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        use Error::*;
        match self {
            InvalidAccountName(err) => err.source(),
            InvalidAccountPassword(err) => err.source(),
            InvalidDisplayName(err) => err.source(),
            InvalidDatabaseName(err) => err.source(),
            InvalidExecutablePath(err) => err.source(),
            InvalidLaunchArgument(_, err) => err.source(),
            InvalidDependency(err) => err.source(),
            InvalidMachineName(err) => err.source(),
            InvalidServiceName(err) => err.source(),
            InvalidStartArgument(err) => err.source(),
            InvalidServiceState(err) => err.source(),
            InvalidServiceStartType(err) => err.source(),
            InvalidServiceErrorControl(err) => err.source(),
            InvalidServiceActionType(err) => err.source(),
            InvalidServiceActionFailuresRebootMessage(err) => err.source(),
            InvalidServiceActionFailuresCommand(err) => err.source(),
            Winapi(err) => err.source(),
        }
    }
}
